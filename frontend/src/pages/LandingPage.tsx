      ...
      <section className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">{features[0].title}</h3>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">{features[1].title}</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">{features[2].title}</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">{features[3].title}</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">{features[4].title}</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">{features[5].title}</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
